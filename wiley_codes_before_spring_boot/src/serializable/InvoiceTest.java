...
public class InvoiceTest {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		System.out.println("Total amount for " + invoice1.getPartDescription() + " is : " + invoice1.getInvoice());
		System.out.println();
		invoice2.displayDetails();
		System.out.println("Total amount for " + invoice2.getPartDescription() + " is : " + invoice2.getInvoice());
