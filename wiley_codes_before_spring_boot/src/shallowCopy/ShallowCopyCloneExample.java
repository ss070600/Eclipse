...
public class ShallowCopyCloneExample {
	...
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		student1.setName("rudra"); // this will not affect the copy/original because we are making change in String
									...
									// reference. Hence it acts like primitives only.
		...
		student2.setId(501); // this will not affect the copy/original because we are making change in
								...
								// actual values are changed here which doesn't affects the copy/original
		...
		student2.course.setSubjectOne("xyz"); // here in this the changes will be reflected in both original/copy
												// because here we are making change at the memory location which is
												// being pointed by both original/copy.
